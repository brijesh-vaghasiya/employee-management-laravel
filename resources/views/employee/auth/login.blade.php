...
<head>
    ...
    <title>Employee Login Gateway | LIMS</title>
    ...
    <div class="login-container">
        <div class="login-card p-5">
            <div class="text-center mb-4">
                ...
                <h3 class="hero-title">Employee Portal</h3>
            ...
            <form action="{{ route('employee.login') }}" method="POST">
                ...
                <button type="submit" class="btn btn-portal w-100 mb-3">Initialize Session</button>
    ...
    <script>
        particlesJS("particles-js", {
            "particles": {
                ...
                "line_linked": { "enable": true, "distance": 150, "color": "#0dcaf0", "opacity": 0.2, "width": 1 },
